const Footer = () => {
    ...
    <div class="container px-5 py-5 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      ...
      <div class="flex-grow flex justify-endflex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
    ...
    <div class="bg-gray-100">
      <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        <p class="text-gray-500 text-sm text-center sm:text-left">Made with ❤ and NextJS —
          <a href="https://github.com/Anush008" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@Anush008</a>
        </p>
