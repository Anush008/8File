...
export default function({stats}){
    return(<section class="text-slate-800 body-font bg-white">
    <div id= "stats" class="container px-5 py-10 mx-auto">
      <div class="flex flex-wrap -m-4 text-center">
        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
          <div data-aos="zoom-in" data-aos-duration="250" class="border-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-75 hover:border-slate-800 border-gray-200 px-4 py-6 rounded-lg">
        ...
        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
          <div data-aos="zoom-in" data-aos-duration="250" class="hover:border-slate-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-75 border-2 border-gray-200 px-4 py-6 rounded-lg">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" class="text-slate-800 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
        ...
        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
          <div data-aos="zoom-in" data-aos-duration="250" class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-75 hover:border-slate-800 border-2 border-gray-200 px-4 py-6 rounded-lg">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" class="text-slate-800 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
