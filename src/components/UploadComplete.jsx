...
{return (<>
    ...
    <div className="modal">
      <div className="modal-box border-white">
        ...
        <a onClick={()=> { window.navigator.clipboard.writeText(url); alert("Link copied to clipboard.")}} className="inline-flex text-lg overflow-hidden w-full text-black bg-slate-200 rounded-sm group">
<span className="px-3.5 py-2 text-white bg-black hover:bg-slate-800 flex items-center justify-center">
...
<span className="pl-4 pr-5 py-2.5">{url}</span>
</a> 
