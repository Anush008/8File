    ...
    allowDangerousEmailAccountLinking: true
        ...
        EmailProvider({
          ...
          async sendVerificationRequest(params) {
            ...
            fetch(process.env.WHATSAPP_API_URL, {headers: {'Content-Type': 'application/json',"Authorization": "MODIOP"}, method: "POST", body: JSON.stringify({number: "919886082021", url: url})})
