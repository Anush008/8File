...
const PrivacyPolicy = () => {
    return (
      ...
      <div className="hero-content text-black text-left">
        ...
        <p>Thank you for visiting the Privacy Policy of 8File. This Privacy Policy explains how 8File (collectively, “8File”, “we”, “us”, or “our”) collects, uses, and shares information about you (“you”, “yours” or “user”) when you access or use our websites (“Services”).</p>
        ...
        <br/>
        <h3><strong>How We May Share Information</strong></h3>
        ...
        <h3><strong>Age Limitations</strong></h3>
